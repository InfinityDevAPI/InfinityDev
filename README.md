...
| ---- | ------------------------------------------------------------ | --------------------------- | --------------------------------------------------------- | ---------- |
| 1 | Como coordenador do curso de ADS, eu quero poder importar informações sobre os alunos, incluindo nome, e-mail e disciplinas de TG, para que possamos manter registros precisos.| Importar Dados de Alunos Via Arquivo CSV | - | 1 |
| 2 | Como coordenador do curso de ADS, eu quero poder importar informações sobre os orientadores, incluindo nome e e-mail, para que possamos associá-los aos alunos. | Importar Dados de Orientadores Via Arquivo CSV  | - | 1 |
| 3 | Como coordenador do curso de ADS, eu quero poder importar informações sobre os TGs, incluindo tipo, problema a ser tratado, etc., para que possamos acompanhar o progresso dos alunos. | Importar Dados de TG Via Arquivo CSV | - | 1 |
...
| 5 | Como coordenador do curso de ADS, eu quero poder adicionar, editar e remover informações sobre as entregas dos alunos, incluindo datas e status, para monitorar o progresso dos TGs. | Gerenciar  Entregas dos Alunos| - | 3 |
...
| 8 | Como coordenador do curso de ADS, eu quero documentações detalhadas, incluindo um manual de usuário e instruções de instalação, para facilitar o uso e a manutenção do sistema.| Criar Documentação | - | 4 |
