...
| ---- | ------------------------------------------------------------ | --------------------------- | --------------------------------------------------------- | ---------- |
| 1 | Como professor, eu quero poder importar informações sobre os alunos, incluindo nome, e-mail e disciplinas de TG, para manter registros precisos.| Importar Dados de Alunos Via Arquivo CSV | - | 1 |
...
| 3 | Como professor , eu quero poder importar informações sobre os TGs, para acompanhar o progresso dos alunos. | Importar Dados de TG Via Arquivo CSV | - | 2 |
...
| 5 | Como professor, eu quero poder adicionar, editar e remover informações sobre as entregas dos alunos, incluindo datas, status e feedbacks, para monitorar o progresso dos TGs. | Gerenciar  Entregas dos Alunos| - | 5 |
| 6 | Como professor, eu quero poder gerar relatórios sobre as entregas dos alunos, para acompanhar o progresso dos TGs. | Gerar Relatórios de Entregas | - | 6 |
| 7 | Como professor, eu quero documentações detalhadas, incluindo um manual de usuário e instruções de instalação, para facilitar o uso e a manutenção do sistema.| Criar Documentação | - | 8 |
